...
function MajorDropDown(){
    ...
    return (
    <>
        <div className="relative w-[255px] h-[37px] top-[230px] left-[105px] rounded-[5px] border-[2px] border-blue bg-white resize-none">
            <textarea
        ...
        <div className="relative top-[228px] left-[105px] inline-block">
                {isOpen && (
